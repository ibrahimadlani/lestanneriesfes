...
/**
 * A functional component that renders a language selection dropdown.
 *
 * This component displays a button with the current language flag and a dropdown
 * menu to select other languages.
 *
 * @component
 * @returns {JSX.Element} A JSX element containing the language selection dropdown.
 */
